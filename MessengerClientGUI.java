...
public class MessengerClientGUI extends JFrame {
  ...
  private final DefaultListModel<String> lstTeilnehmerModel =
      new DefaultListModel<>();
  private final JScrollPane lstTeilnehmerScrollPane =
      new JScrollPane(lstTeilnehmer);
  private final JLabel lTeilnehmer = new JLabel();
  private final JTextArea taNachrichten = new JTextArea("");
  private final JScrollPane taNachrichtenScrollPane =
      new JScrollPane(taNachrichten);
  ...
  public MessengerClientGUI() { this(CONST_SERVERIP, CONST_SERVERPORT); }
  ...
  public MessengerClientGUI(String pServerIp, int pPort) {
    ...
    lstTeilnehmer.setSelectionMode(
    ...
    bRegister.addActionListener(evt -> {
      ...
      int result = JOptionPane.showConfirmDialog(
          this, registerPanel, "Registrierung", JOptionPane.OK_CANCEL_OPTION);
      if (result == JOptionPane.OK_OPTION && !nameField.getText().equals("") &&
          !passwordField.getText().equals("")) {
        messengerClient.registrieren(nameField.getText(),
    ...
    bLogIn.addActionListener(evt -> {
      ...
      int result = JOptionPane.showConfirmDialog(this, registerPanel, "LogIn",
  ...
  public void bSenden_ActionPerformed(ActionEvent evt) {
    if (!lstTeilnehmer.getSelectedValuesList().isEmpty()) {
      messengerClient.nachrichtSenden(lstTeilnehmer.getSelectedValuesList(),
                                      tfNachricht.getText());
      tfNachricht.setText("");
    }
  ...
  public static void main(String[] args) { new MessengerClientGUI(); }
